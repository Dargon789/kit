import { c as commonjsGlobal, B as Buffer$7, a as getAugmentedNamespace, p as process$1, t as tslib_es6, e as eventemitter3Exports, g as getDefaultExportFromCjs } from "./index-Dua3QHZr.js";
import { r as require$$0$2, i as inherits_browserExports, e as eventsExports, a as require$$0$3 } from "./___vite-browser-external_commonjs-proxy-Cg5Cr4xP.js";
import { p as preact_module, a as clsx_m, b as hooks_module } from "./hooks.module-B8FgZbnF.js";
import { b as browserExports } from "./browser-up1aEO0w.js";
var dist$5 = {};
...
function toBuffer(v) {
  if (!Buffer$7.isBuffer(v)) {
    if (Array.isArray(v)) {
      v = Buffer$7.from(v);
    } else if (typeof v === "string") {
      if (isHexString(v)) {
        v = Buffer$7.from(padToEven(stripHexPrefix(v)), "hex");
      } else {
        v = Buffer$7.from(v);
      }
      ...
      v = Buffer$7.allocUnsafe(0);
    } else if (BN$1.isBN(v)) {
      v = v.toArrayLike(Buffer$7);
    } else if (v.toArray) {
      v = Buffer$7.from(v.toArray());
    } else {
