import { B as Buffer, g as getDefaultExportFromCjs, b as bytesToHex, s as sha256, E as EventEmitter } from "./index-Bjo-TXDC.js";
...
function ensureAddressString(str) {
  if (typeof str === "string") {
    ...
    if (isHexString$1(s2) && s2.length === 40) {
      return AddressString(prepend0x(s2));
    }
  }
...
function rawEncode(types, values) {
  ...
  for (var i2 in types) {
    var type = elementaryName(types[i2]);
    var value = values[i2];
...
var n, l$1, u$1, i$1, r$1, o$1, e$1, f$1, c$1, s$1, a$1, p$1 = {}, v$1 = [], y$1 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, d$1 = Array.isArray;
function w$1(n2, l2) {
...
function I(n2, l2, u2, t2) {
  ...
  for (n2.__k = [], i2 = 0; i2 < c2; i2++) null != (r2 = l2[i2]) && "boolean" != typeof r2 && "function" != typeof r2 ? (e2 = i2 + h2, (r2 = n2.__k[i2] = "string" == typeof r2 || "number" == typeof r2 || "bigint" == typeof r2 || r2.constructor == String ? m$1(null, r2, null, null, null) : d$1(r2) ? m$1(k$1, { children: r2 }, null, null, null) : void 0 === r2.constructor && r2.__b > 0 ? m$1(r2.type, r2.props, r2.key, r2.ref ? r2.ref : null, r2.__v) : r2).__ = n2, r2.__b = n2.__b + 1, o2 = null, -1 !== (f2 = r2.__i = T(r2, u2, e2, a2)) && (a2--, (o2 = u2[f2]) && (o2.__u |= 2)), null == o2 || null === o2.__v ? (-1 == f2 && h2--, "function" != typeof r2.type && (r2.__u |= 4)) : f2 !== e2 && (f2 == e2 - 1 ? h2-- : f2 == e2 + 1 ? h2++ : (f2 > e2 ? h2-- : h2++, r2.__u |= 4))) : r2 = n2.__k[i2] = null;
  if (a2) for (i2 = 0; i2 < s2; i2++) null != (o2 = u2[i2]) && 0 == (2 & o2.__u) && (o2.__e == t2 && (t2 = C$1(o2)), q(o2, o2));
  return t2;
}
function H(n2, l2, u2) {
  var t2, i2;
...
function F(n2, l2, u2, t2, i2) {
  ...
  n: if ("style" === l2) if ("string" == typeof u2) n2.style.cssText = u2;
    ...
    if ("string" == typeof t2 && (n2.style.cssText = t2 = ""), t2) for (l2 in t2) u2 && l2 in u2 || A(n2.style, l2, "");
    if (u2) for (l2 in u2) t2 && u2[l2] === t2[l2] || A(n2.style, l2, u2[l2]);
  }
...
function D$1(u2, t2, i2) {
  var r2, o2, e2, f2;
  t2 === document && (t2 = document.documentElement), l$1.__ && l$1.__(u2, t2), o2 = (r2 = "function" == typeof i2) ? null : t2.__k, e2 = [], f2 = [], j$1(t2, u2 = (!r2 && i2 || t2).__k = g(k$1, null, [u2]), o2 || p$1, p$1, t2.namespaceURI, !r2 && i2 ? [i2] : o2 ? null : t2.firstChild ? n.call(t2.childNodes) : null, e2, !r2 && i2 ? i2 : o2 ? o2.__e : t2.firstChild, r2, f2), z$1(e2, u2, f2);
}
...
const SnackbarInstance = ({ autoExpand, message, menuItems }) => {
  ...
  return g(
    ...
    menuItems && menuItems.length > 0 && g("div", { class: "-cbwsdk-snackbar-instance-menu" }, menuItems.map((action, i2) => g(
      "div",
...
class RedirectDialog {
  ...
  render(props) {
    ...
    if (!props)
      return;
    D$1(g(RedirectDialogContent, Object.assign({}, props, { onDismiss: () => {
      this.clear();
