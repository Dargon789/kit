import { c as commonjsGlobal, B as Buffer$7, a as getAugmentedNamespace, p as process$1, t as tslib_es6, e as eventemitter3Exports, g as getDefaultExportFromCjs } from "./index-Bjo-TXDC.js";
import { r as require$$0$2, i as inherits_browserExports, e as eventsExports, a as require$$0$3 } from "./___vite-browser-external_commonjs-proxy-CB9WvdSG.js";
import { a as clsx_m } from "./clsx.m-D57qXwfE.js";
import { b as browserExports } from "./browser-CoSurfYl.js";
var dist$5 = {};
...
function ensureBuffer(str) {
  if (Buffer$7.isBuffer(str)) {
    return str;
  }
  if (typeof str === "string") {
    if (isHexString$1(str)) {
      const s2 = ensureEvenLengthHexString(str, false);
      return Buffer$7.from(s2, "hex");
    }
    return Buffer$7.from(str, "utf8");
  }
...
var LinkFlow$1 = {};
var n, l$1, u$1, t$3, i$2, o$1, r$1, f$1, e$1, c$1, s$1, a$1, h$1 = {}, v$1 = [], p$1 = /acit|ex(?:s|g|n|p|$)|rph|grid|ows|mnc|ntw|ine[ch]|zoo|^ord|itera/i, y$1 = Array.isArray;
function d$1(n2, l2) {
...
function M(n2) {
  (!n2.__d && (n2.__d = true) && i$2.push(n2) && !P$1.__r++ || o$1 !== l$1.debounceRendering) && ((o$1 = l$1.debounceRendering) || r$1)(P$1);
}
function P$1() {
...
function $(n2, l2, u2) {
  ...
  for (n2.__k = [], t2 = 0; t2 < e2; t2++) null != (i = l2[t2]) && "boolean" != typeof i && "function" != typeof i ? (r2 = t2 + a2, (i = n2.__k[t2] = "string" == typeof i || "number" == typeof i || "bigint" == typeof i || i.constructor == String ? g$1(null, i, null, null, null) : y$1(i) ? g$1(b$1, { children: i }, null, null, null) : void 0 === i.constructor && i.__b > 0 ? g$1(i.type, i.props, i.key, i.ref ? i.ref : null, i.__v) : i).__ = n2, i.__b = n2.__b + 1, o2 = null, -1 !== (f2 = i.__i = L(i, u2, r2, s2)) && (s2--, (o2 = u2[f2]) && (o2.__u |= 131072)), null == o2 || null === o2.__v ? (-1 == f2 && a2--, "function" != typeof i.type && (i.__u |= 65536)) : f2 !== r2 && (f2 == r2 - 1 ? a2-- : f2 == r2 + 1 ? a2++ : (f2 > r2 ? a2-- : a2++, i.__u |= 65536))) : i = n2.__k[t2] = null;
...
function O(n2, u2, t2, i, o2, r2, f2, e2, c2, s2) {
  ...
  n: if ("function" == typeof T2) try {
    ...
    h2.state = h2.__s, null != h2.getChildContext && (i = d$1(d$1({}, i), h2.getChildContext())), x2 && !v2 && null != h2.getSnapshotBeforeUpdate && (_2 = h2.getSnapshotBeforeUpdate(p2, w2)), S(n2, y$1(L2 = null != a2 && a2.type === b$1 && null == a2.key ? a2.props.children : a2) ? L2 : [L2], u2, t2, i, o2, r2, f2, e2, c2, s2), h2.base = u2.__e, u2.__u &= -161, h2.__h.length && f2.push(h2), g2 && (h2.__E = h2.__ = null);
  } catch (n3) {
...
function z$1(u2, t2, i, o2, r2, f2, e2, c2, s2) {
  ...
  if (null === C2) b2 === k2 || c2 && u2.data === k2 || (u2.data = k2);
    ...
    if (f2 = f2 && n.call(u2.childNodes), b2 = i.props || h$1, !c2 && null != f2) for (b2 = {}, a2 = 0; a2 < u2.attributes.length; a2++) b2[(_2 = u2.attributes[a2]).name] = _2.value;
...
function B$1(u2, t2, i) {
  var o2, r2, f2, e2;
  l$1.__ && l$1.__(u2, t2), r2 = (o2 = "function" == typeof i) ? null : i && i.__k || t2.__k, f2 = [], e2 = [], O(t2, u2 = (!o2 && i || t2).__k = _$1(b$1, null, [u2]), r2 || h$1, h$1, t2.namespaceURI, !o2 && i ? [i] : r2 ? null : t2.firstChild ? n.call(t2.childNodes) : null, f2, !o2 && i ? i : r2 ? r2.__e : t2.firstChild, o2, e2), j$1(f2, u2, e2);
}
function D$1(n2, l2) {
  B$1(n2, l2, D$1);
}
...
}, k$1.prototype.render = b$1, i$2 = [], r$1 = "function" == typeof Promise ? Promise.prototype.then.bind(Promise.resolve()) : setTimeout, f$1 = function(n2, l2) {
...
var t$2, r, u, i$1, o = 0, f = [], c = l$1, e = c.__b, a = c.__r, v = c.diffed, l = c.__c, m = c.unmount, s = c.__;
function d(n2, t2) {
...
function x(n2) {
  var u2 = r.context[n2.__c], i = d(t$2++, 9);
...
c.__b = function(n2) {
  ...
  })) : (i.__h.forEach(z), i.__h.forEach(B), i.__h = [], t$2 = 0)), u = r;
...
const QRCode = (props) => {
  ...
  (0, hooks_1$2.useEffect)(() => {
    ...
    const base642 = Buffer$7.from(qrcode.svg(), "utf8").toString("base64");
...
const clsx_1$3 = __importDefault$9(require$$0$1);
...
const clsx_1$2 = __importDefault$8(require$$0$1);
...
const clsx_1$1 = __importDefault$7(require$$0$1);
...
(function(exports2) {
  ...
  Object.defineProperty(exports2, "__esModule", { value: true });
  __exportStar(Snackbar$1, exports2);
})(Snackbar);
...
const clsx_1 = __importDefault$6(require$$0$1);
...
function zeros(bytes2) {
  return Buffer$7.allocUnsafe(bytes2).fill(0);
}
...
function toBuffer(v2) {
  if (!Buffer$7.isBuffer(v2)) {
    if (Array.isArray(v2)) {
      v2 = Buffer$7.from(v2);
    } else if (typeof v2 === "string") {
      if (isHexString(v2)) {
        v2 = Buffer$7.from(padToEven(stripHexPrefix(v2)), "hex");
      } else {
        v2 = Buffer$7.from(v2);
      }
      ...
      v2 = Buffer$7.allocUnsafe(0);
    } else if (BN$1.isBN(v2)) {
      v2 = v2.toArrayLike(Buffer$7);
    } else if (v2.toArray) {
      v2 = Buffer$7.from(v2.toArray());
    } else {
...
function encodeSingle(type2, arg) {
  ...
  if (type2 === "address") {
    ...
    return encodeSingle("bytes", new Buffer$7(arg, "utf8"));
    ...
    return Buffer$7.concat(ret);
  } else if (type2 === "bytes") {
    arg = new Buffer$7(arg);
    ret = Buffer$7.concat([encodeSingle("uint256", arg.length), arg]);
    if (arg.length % 32 !== 0) {
      ret = Buffer$7.concat([ret, util$1.zeros(32 - arg.length % 32)]);
    }
    return ret;
    ...
    return num.toArrayLike(Buffer$7, "be", 32);
    ...
    return num.toTwos(256).toArrayLike(Buffer$7, "be", 32);
...
function rawEncode(types, values) {
  ...
  return Buffer$7.concat(output.concat(data));
}
function solidityPack(types, values) {
  ...
  for (var i = 0; i < types.length; i++) {
    ...
    if (type2 === "bytes") {
      ...
      ret.push(new Buffer$7(value, "utf8"));
    } else if (type2 === "bool") {
      ret.push(new Buffer$7(value ? "01" : "00", "hex"));
      ...
      ret.push(num.toArrayLike(Buffer$7, "be", size2 / 8));
    } else if (type2.startsWith("int")) {
      size2 = parseTypeN(type2);
      if (size2 % 8 || size2 < 8 || size2 > 256) {
        throw new Error("Invalid int<N> width: " + size2);
      ...
      ret.push(num.toTwos(size2).toArrayLike(Buffer$7, "be", size2 / 8));
    } else {
      throw new Error("Unsupported or invalid type: " + type2);
    }
  }
...
const TypedDataUtils = {
      ...
      const encodeField = (name, type2, value) => {
        ...
        if (type2 === "string") {
          if (typeof value === "string") {
            value = Buffer$7.from(value, "utf8");
          }
          return ["bytes32", util.keccak(value)];
        }
  ...
  hash(typedData, useV4 = true) {
    ...
    const parts = [Buffer$7.from("1901", "hex")];
    parts.push(this.hashStruct("EIP712Domain", sanitizedData.domain, sanitizedData.types, useV4));
    if (sanitizedData.primaryType !== "EIP712Domain") {
      parts.push(this.hashStruct(sanitizedData.primaryType, sanitizedData.message, sanitizedData.types, useV4));
    }
    return util.keccak(Buffer$7.concat(parts));
  }
};
var ethEip712Util = {
...
function createDataView(bytes2) {
  if (typeof Buffer$7 !== "undefined" && bytes2 instanceof Buffer$7) {
...
(function(exports2) {
  ...
  Object.defineProperty(exports2, "__esModule", { value: true });
  __exportStar(PollingBlockTracker$1, exports2);
  __exportStar(SubscribeBlockTracker$1, exports2);
})(dist$4);
var dist$1 = {};
...
class CoinbaseWalletProvider extends eventemitter3_1.EventEmitter {
  ...
  _prepareTransactionParams(tx) {
    ...
    const data = tx.data ? (0, util_1$2.ensureBuffer)(tx.data) : Buffer$7.alloc(0);
