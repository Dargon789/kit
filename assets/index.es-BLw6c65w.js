const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index--H9C3ZQb.js","./index-Br1w9h21.js","./index-D9No3ai6.css"])))=>i.map(i=>d[i]);
import { p as process$1, a as getAugmentedNamespace, c as commonjsGlobal, d as global, B as Buffer, r as recoverAddress, g as getDefaultExportFromCjs, _ as __vitePreload } from "./index-Br1w9h21.js";
import { r as require$$0$2, a as require$$0$3, i as inherits_browserExports, e as eventsExports, w as wt$4 } from "./___vite-browser-external_commonjs-proxy-DyYD_fXk.js";
...
class w {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? v(this.rpc.chains) : v(this.rpc.optionalChains), this.signer = await oh.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storage: t.storage, storageOptions: t.storageOptions, customStoragePrefix: t.customStoragePrefix, telemetryEnabled: t.telemetryEnabled, logger: t.logger }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s2;
      try {
        const { WalletConnectModal: i3 } = await __vitePreload(() => import("./index--H9C3ZQb.js").then((n3) => n3.i), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
        s2 = i3;
      } catch {
