const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-BUi-qguR.js","./index-DgB-f-A2.js","./index-BHwcnrtI.css"])))=>i.map(i=>d[i]);
import { p as process$1, d as getAugmentedNamespace, j as global, B as Buffer, m as recoverAddress, o as elliptic, e as eventsExports, g as getDefaultExportFromCjs, c as commonjsGlobal, w as wt$4, _ as __vitePreload } from "./index-DgB-f-A2.js";
...
class w {
  ...
  async initialize(t) {
    if (this.rpc = this.getRpcConfig(t), this.chainId = this.rpc.chains.length ? v(this.rpc.chains) : v(this.rpc.optionalChains), this.signer = await oh.init({ projectId: this.rpc.projectId, metadata: this.rpc.metadata, disableProviderPing: t.disableProviderPing, relayUrl: t.relayUrl, storage: t.storage, storageOptions: t.storageOptions, customStoragePrefix: t.customStoragePrefix, telemetryEnabled: t.telemetryEnabled, logger: t.logger }), this.registerEventListeners(), await this.loadPersistedSession(), this.rpc.showQrModal) {
      let s2;
      try {
        const { WalletConnectModal: i3 } = await __vitePreload(() => import("./index-BUi-qguR.js").then((n3) => n3.i), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
        s2 = i3;
      } catch {
