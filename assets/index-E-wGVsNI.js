const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-C30H_LA0.js","./index-BPD9bzGp.js","./index-DRJyHRQj.css"])))=>i.map(i=>d[i]);
import { B as Buffer, _ as __vitePreload } from "./index-BPD9bzGp.js";
const t = Symbol();
...
class WalletConnectModal {
  ...
  async initUi() {
    if (typeof window !== "undefined") {
      await __vitePreload(() => import("./index-C30H_LA0.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
