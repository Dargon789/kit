const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-vGGTC2-v.js","./index-BCNfMXv2.js","./index-CHAXH4d-.css"])))=>i.map(i=>d[i]);
import { B as Buffer, _ as __vitePreload } from "./index-BCNfMXv2.js";
const t = Symbol();
...
class WalletConnectModal {
  ...
  async initUi() {
    if (typeof window !== "undefined") {
      await __vitePreload(() => import("./index-vGGTC2-v.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
