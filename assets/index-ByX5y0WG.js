const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./index-Dw0vWN2j.js","./index-D3WJyOba.js","./index-BHwcnrtI.css"])))=>i.map(i=>d[i]);
import { B as Buffer, _ as __vitePreload } from "./index-D3WJyOba.js";
const t = Symbol();
...
class WalletConnectModal {
  ...
  async initUi() {
    if (typeof window !== "undefined") {
      await __vitePreload(() => import("./index-Dw0vWN2j.js"), true ? __vite__mapDeps([0,1,2]) : void 0, import.meta.url);
