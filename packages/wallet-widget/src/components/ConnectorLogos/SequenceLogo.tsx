export const SequenceLogo: React.FC = () => {
  return (
    <svg xmlns="http://www.w3.org/2000/svg" style={{ fill: 'none' }} id="svg1316" version="1.1" viewBox="0 0 396 396">
      ...
      <defs id="defs1314">
        ...
        >
          <stop id="stop1268" stopColor="#3757FD" />
          <stop id="stop1270" stopColor="#6980FA" offset="1" />
        </linearGradient>
        <linearGradient
          gradientUnits="userSpaceOnUse"
          y2="97.591103"
        ...
        <clipPath id="clip0_5_131">
          <rect height="317.67001" width="396" style={{ fill: '#ffffff' }} y="0" x="0" id="rect1308" />
        </clipPath>
        <clipPath id="clip1_5_131">
          <rect height="317.67001" width="396" style={{ fill: '#ffffff' }} y="0" x="0" id="rect1311" />
        </clipPath>
      </defs>
    </svg>
  )
